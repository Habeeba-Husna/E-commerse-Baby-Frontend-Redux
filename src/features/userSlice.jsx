...
// export const fetchSingleUser = createAsyncThunk("user/fetchSingleUser", async (userId, { rejectWithValue }) => {
//   try {
//     const response = await axiosInstance.get(endPoints.USER.GET_SINGLE_USER(userId));
//     return response.data;
//   } catch (error) {
...
// export const blockUser = createAsyncThunk("user/blockUser", async (userId, { rejectWithValue }) => {
//   try {
//     const response = await axiosInstance.put(endPoints.USER.BLOCK_USER(userId));
//     return response.data;
//   } catch (error) {
...
//   name: "user",
//   initialState: { users: [], singleUser: null, loading: false, error: null },
//   reducers: {},
//   extraReducers: (builder) => {
//     builder
//       .addCase(fetchAllUsers.fulfilled, (state, action) => { state.users = action.payload; })
//       .addCase(fetchSingleUser.fulfilled, (state, action) => { state.singleUser = action.payload; })
//       .addCase(blockUser.fulfilled, (state, action) => {
//         state.users = state.users.map(user => user._id === action.meta.arg ? { ...user, blocked: true } : user);
//       });
//   },
// });
