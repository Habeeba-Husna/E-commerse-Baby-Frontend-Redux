...
//     [users] // Recalculate when 'users' changes
//   );
...
//   //     users?.reduce(
//   //       (acc, user) =>
//   //         acc + (user.order?.reduce((sum, order) => sum + order.total, 0) || 0),
//   //       0
//   //     ) || 0,
//   //   [users]
//   // );
...
//       return 0; // Return 0 if users data isn't available yet
//     }
  
//     return users.reduce((acc, user) => {
//       const userTotal = user?.order?.reduce((sum, order) => {
//         return sum + (order?.total || 0); // Handle missing order or total fields
//       }, 0);
...
//       </div>
//       {/* main dashboard */}
//       <div className="w-4/5 flex-grow bg-gray-50 p-6 overflow-y-auto">
      
   
//     {/* <div className="container mx-auto px-4 py-10"> */}
//       <h1 className="text-center font-bold text-4xl text-rose-500 mb-10">
//         Dashboard Overview
//       </h1>
...
const Dashboard = () => {
 ...
 // If `true` means blocked, update as follows
const blockCount = useMemo(
